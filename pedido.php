  ...
  <section id="container-pedido">
    <div class="container">
      <div class="page-header">
        <h1>PEDIDOS <small class="tittles-pages-logo">XTREME</small></h1>
      </div>
      <br><br><br>
      <div class="row">
              ...
              <div class="container-fluid">
                <div class="row">
                  <div class="col-xs-10 col-xs-offset-1">
                    ...
                    <p class="text-center">
                      <button class="btn btn-lg btn-raised btn-success btn-block" data-toggle="modal" data-target="#PagoModalTran">Transacción Bancaria</button>
                    </p>
                    <p class="text-center lead">O paga con Yape</p>
                    <img class="img-responsive center-all-contens" src="assets/img/yape.jpg" alt="QR para pagos Yape">
                    <p class="text-center">
                      <button class="btn btn-lg btn-raised btn-success btn-block" data-toggle="modal" data-target="#PagoModalYape">Confirmar Pago con Yape</button>
                    </p>
                  </div>

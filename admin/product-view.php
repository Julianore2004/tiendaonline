            ...
            <div class="row">
              ...
              <div class="col-xs-12">
                <div class="form-group label-floating">
                  ...
                  <input type="url" class="form-control" name="img1">
                </div>
              </div>
              <div class="col-xs-12">
                <div class="form-group label-floating">
                  <label class="control-label">Imagen 2 (URL)</label>
                  <input type="url" class="form-control" name="img2">
                </div>
              </div>
              <div class="col-xs-12">
                <div class="form-group label-floating">
                  <label class="control-label">Imagen 3 (URL)</label>
                  <input type="url" class="form-control" name="img3">
                </div>
              </div>
              <div class="col-xs-12">
                <div class="form-group label-floating">
                  <label class="control-label">Imagen 4 (URL)</label>
                  <input type="url" class="form-control" name="img4">
                </div>
              </div>
            </div>
          </div>

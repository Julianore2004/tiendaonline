...
$codeDeProd = consultasSQL::clean_string($_POST['prod-codigodeproducto']);
...
if ($codeProd != "" && $nameProd != "" && $cateProd != "" && $marcaProd != "" && $stockProd != "" && $codePProd != "") {
    ...
    echo '<script>swal("ERROR", "Los campos obligatorios no deben de estar vacíos, por favor verifique e intente nuevamente", "error");</script>';
}
